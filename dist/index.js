...
/***/ "./node_modules/sillytavern-utils-lib/dist/types/translate.js":
/*!********************************************************************!*\
  !*** ./node_modules/sillytavern-utils-lib/dist/types/translate.js ***!
  \********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AutoModeOptions: () => (/* binding */ AutoModeOptions)
/* harmony export */ });
var AutoModeOptions;
(function (AutoModeOptions) {
    AutoModeOptions["NONE"] = "none";
    AutoModeOptions["RESPONSES"] = "responses";
    AutoModeOptions["INPUT"] = "inputs";
    AutoModeOptions["BOTH"] = "both";
...
var translate_1 = __webpack_require__(/*! sillytavern-utils-lib/types/translate */ "./node_modules/sillytavern-utils-lib/dist/types/translate.js");
...
var defaultSettings = {
  ...
  autoMode: translate_1.AutoModeOptions.NONE,
  schemaPreset: 'default',
  schemaPresets: {
    "default": {
      name: 'Default',
      value: config_js_1.DEFAULT_SCHEMA_VALUE
    }
  },
  prompt: config_js_1.DEFAULT_PROMPT
};
// Keys for extension settings
var EXTENSION_KEY = 'WTracker';
var CHAT_METADATA_SCHEMA_VALUE_KEY = 'schemaValue';
var globalContext = SillyTavern.getContext();
var settingsManager = new sillytavern_utils_lib_1.ExtensionSettingsManager(EXTENSION_KEY, defaultSettings);
var incomingTypes = [translate_1.AutoModeOptions.RESPONSES, translate_1.AutoModeOptions.BOTH];
var outgoingTypes = [translate_1.AutoModeOptions.INPUT, translate_1.AutoModeOptions.BOTH];
function initUI() {
  return _initUI.apply(this, arguments);
}
function _initUI() {
  _initUI = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
    var _extensionsMenu$query;
    var settingsHtml, extensionsSettings, wTrackerIcon, messageTemplate, settings, extensionsMenu, wTrackerWandContainer, buttonHtml;
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        case 0:
          _context5.n = 1;
          return globalContext.renderExtensionTemplateAsync("third-party/SillyTavern-WTracker", 'templates/settings', {});
        case 1:
          settingsHtml = _context5.v;
          extensionsSettings = document.getElementById('extensions_settings');
          if (extensionsSettings) {
            extensionsSettings.insertAdjacentHTML('beforeend', settingsHtml);
          }
          // Initialize settings UI
          _context5.n = 2;
          return initSettingsUI();
        case 2:
          // WTracker icon to message buttons
          wTrackerIcon = document.createElement('div');
          ...
          messageTemplate = document.querySelector('#message_template .mes_buttons .extraMesButtons');
          if (messageTemplate) {
            messageTemplate.prepend(wTrackerIcon);
          }
          document.addEventListener('click', /*#__PURE__*/function () {
            var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(event) {
              var target, messageBlock, messageId;
              return _regenerator().w(function (_context) {
                while (1) switch (_context.n) {
                  case 0:
                    ...
                    messageBlock = target.closest('.mes');
                    if (!messageBlock) {
                      _context.n = 1;
                      break;
                    }
                    messageId = Number(messageBlock.getAttribute('mesid'));
                    _context.n = 1;
                    return generateTracker(messageId);
                  case 1:
                    return _context.a(2);
                }
              }, _callee);
          ...
          settings = settingsManager.getSettings(); // @ts-ignore
          globalContext.eventSource.makeFirst(types_1.EventNames.CHARACTER_MESSAGE_RENDERED, /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(messageId) {
          ...
          // @ts-ignore
          globalContext.eventSource.makeFirst(types_1.EventNames.USER_MESSAGE_RENDERED, /*#__PURE__*/function () {
          ...
          extensionsMenu = document.querySelector('#extensionsMenu');
          wTrackerWandContainer = document.createElement('div');
          wTrackerWandContainer.id = 'wtracker_wand_container';
          wTrackerWandContainer.className = 'extension_container';
          extensionsMenu === null || extensionsMenu === void 0 || extensionsMenu.appendChild(wTrackerWandContainer);
          _context5.n = 3;
          return globalContext.renderExtensionTemplateAsync('third-party/SillyTavern-WTracker', 'templates/buttons');
        case 3:
          buttonHtml = _context5.v;
          wTrackerWandContainer.insertAdjacentHTML('beforeend', buttonHtml);
          extensionsMenu === null || extensionsMenu === void 0 || (_extensionsMenu$query = extensionsMenu.querySelector('#wtracker_modify_schema')) === null || _extensionsMenu$query === void 0 || _extensionsMenu$query.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
            var context, chatJsonValue;
            return _regenerator().w(function (_context4) {
              while (1) switch (_context4.n) {
                ...
                case 1:
                  ...
                  _context4.n = 2;
                  return (0, config_1.st_echo)('error', 'Chat metadata schema is not set. Please select a schema preset first in the settings.');
                case 2:
                  return _context4.a(2);
                case 3:
                  context.chatMetadata[EXTENSION_KEY][CHAT_METADATA_SCHEMA_VALUE_KEY] = settings.schemaPresets[settings.schemaPreset].value;
                  context.saveMetadataDebounced();
                case 4:
                  chatJsonValue = context.chatMetadata[EXTENSION_KEY][CHAT_METADATA_SCHEMA_VALUE_KEY];
                  _context4.n = 5;
                  return globalContext.Popup.show.input('Modify WTracker Schema', 'Enter the new schema value in JSON format:', JSON.stringify(chatJsonValue, null, 2), {
                    wider: true,
                    large: true,
                    rows: 16,
                    onClose: function onClose(popup) {
                      var result = popup.result;
                      if (result === popup_1.POPUP_RESULT.AFFIRMATIVE) {
                        try {
                          var newValue = JSON.parse(popup.mainInput.value);
                          context.chatMetadata[EXTENSION_KEY][CHAT_METADATA_SCHEMA_VALUE_KEY] = newValue;
                          context.saveMetadataDebounced();
                          (0, config_1.st_echo)('success', 'Schema value updated successfully.');
                        } catch (error) {
                          (0, config_1.st_echo)('error', 'Invalid JSON format. Please check your input.');
                    ...
                    onClosing: function onClosing(popup) {
                      var result = popup.result;
                      if (result === popup_1.POPUP_RESULT.AFFIRMATIVE) {
                        try {
...
function initSettingsUI() {
  return _initSettingsUI.apply(this, arguments);
}
function _initSettingsUI() {
  _initSettingsUI = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
    var settingsContainer, settings, autoModeSelect, schemaPresetSelect, schemaTextArea, restoreDefaultButton, promptTextArea, restorePromptButton, maxResponseTokensInput, resetButton;
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.n) {
        case 0:
          settingsContainer = document.querySelector('.wtracker-settings');
        ...
        case 1:
          settings = settingsManager.getSettings(); // Connection Profile
          globalContext.ConnectionManagerRequestService.handleDropdown('#wtracker_connection_profile', settings.profileId, function (profile) {
            var _profile$id;
            settings.profileId = (_profile$id = profile === null || profile === void 0 ? void 0 : profile.id) !== null && _profile$id !== void 0 ? _profile$id : '';
            settingsManager.saveSettings();
          });
          // Auto Mode
          autoModeSelect = settingsContainer.querySelector('#wtracker_auto_mode');
          autoModeSelect.value = settings.autoMode;
          autoModeSelect.addEventListener('change', function () {
            settings.autoMode = autoModeSelect.value;
            settingsManager.saveSettings();
          });
          // Schema Presets
          schemaPresetSelect = settingsContainer.querySelector('#wtracker_schema_preset');
          schemaTextArea = settingsContainer.querySelector('#wtracker_schema');
          ...
          (0, sillytavern_utils_lib_1.buildPresetSelect)('#wtracker_schema_preset', {
            initialList: Object.entries(settings.schemaPresets).map(function (_ref5) {
            ...
            onSelectChange: function () {
              var _onSelectChange = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(_previousValue, newValue) {
                var newPresetValue, preset;
                return _regenerator().w(function (_context6) {
                  while (1) switch (_context6.n) {
                    case 0:
                      newPresetValue = newValue !== null && newValue !== void 0 ? newValue : 'default';
                      preset = settings.schemaPresets[newPresetValue];
              ...
              function onSelectChange(_x5, _x6) {
            ...
            rename: {
              onAfterRename: function onAfterRename(_previousValue, newValue) {
          ...
          restoreDefaultButton = settingsContainer.querySelector('.restore_default');
          restoreDefaultButton.addEventListener('click', function () {
            schemaTextArea.value = JSON.stringify(config_js_1.DEFAULT_SCHEMA_VALUE, null, 2);
            settingsManager.saveSettings();
          });
          // Schema Text Area
          schemaTextArea.addEventListener('change', function () {
            try {
              var value = JSON.parse(schemaTextArea.value);
              settings.schemaPresets[schemaPresetSelect.value].value = value;
            } catch (error) {
              (0, config_1.st_echo)('error', 'Invalid JSON format in schema text area');
              console.error('Invalid JSON:', error);
            }
          });
          // Prompt Text Area
          promptTextArea = settingsContainer.querySelector('#wtracker_prompt');
          ...
          restorePromptButton = settingsContainer.querySelector('.restore_default');
          restorePromptButton.addEventListener('click', function () {
            promptTextArea.value = config_js_1.DEFAULT_PROMPT;
            settings.prompt = config_js_1.DEFAULT_PROMPT;
            settingsManager.saveSettings();
          });
          // Max Response Tokens
          maxResponseTokensInput = settingsContainer.querySelector('#wtracker_max_response_tokens');
          maxResponseTokensInput.value = settings.maxResponseToken.toString();
          maxResponseTokensInput.addEventListener('input', function () {
            var value = parseInt(maxResponseTokensInput.value, 10);
            if (!isNaN(value) && value > 0) {
              settings.maxResponseToken = value;
              settingsManager.saveSettings();
            } else {
              (0, config_1.st_echo)('error', 'Max response tokens must be a positive integer');
              maxResponseTokensInput.value = settings.maxResponseToken.toString();
            }
          });
          // Reset Button
          resetButton = settingsContainer.querySelector('#wtracker_reset_button');
          if (resetButton) {
            resetButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
              var confirmed;
              return _regenerator().w(function (_context7) {
                while (1) switch (_context7.n) {
                  case 0:
                    _context7.n = 1;
                    return globalContext.Popup.show.confirm('Reset Settings', 'This will reset all WTracker settings to their default values. Are you sure?');
                  case 1:
                    confirmed = _context7.v;
                    if (!confirmed) {
                      _context7.n = 2;
                      break;
                    }
...
function resetSettingsToDefaults() {
  return _resetSettingsToDefaults.apply(this, arguments);
}
function _resetSettingsToDefaults() {
  _resetSettingsToDefaults = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
    var settingsContainer, settings, autoModeSelect;
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.n) {
        ...
        case 1:
          settings = settingsManager.getSettings(); // Update all UI elements with default values
          autoModeSelect = settingsContainer.querySelector('#wtracker_auto_mode');
          autoModeSelect.value = settings.autoMode;
          (0, config_1.st_echo)('info', 'Settings have been reset to defaults');
        case 2:
          return _context9.a(2);
      }
    }, _callee9);
...
function generateTracker(_x) {
  return _generateTracker.apply(this, arguments);
}
function _generateTracker() {
  _generateTracker = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(id) {
    var _context$extensionSet;
    var message, settings, context, chatJsonValue, profile, apiMap, targetMessage, characterId, currentButton, promptResult, messages, rest, _t;
    return _regenerator().w(function (_context0) {
      while (1) switch (_context0.p = _context0.n) {
        case 0:
          message = SillyTavern.getContext().chat[id];
          if (message) {
            _context0.n = 1;
            break;
          }
          (0, config_1.st_echo)('error', "Message with ID ".concat(id, " not found."));
        ...
        case 2:
          return _context0.a(2);
        case 3:
          context = SillyTavern.getContext(); // Ensure chat metadata schema is set
          if (!context.chatMetadata[EXTENSION_KEY]) {
            context.chatMetadata[EXTENSION_KEY] = {};
            context.saveMetadataDebounced();
          }
        ...
        case 7:
          ...
          currentButton = document.querySelector(".mes[mesid=\"".concat(id, "\"] .mes_wtracker_button"));
          _context0.p = 8;
        ...
        case 10:
          ...
          currentButton === null || currentButton === void 0 || currentButton.classList.add('spinning');
          _context0.n = 11;
        ...
        case 14:
          ...
          currentButton === null || currentButton === void 0 || currentButton.classList.remove('spinning');
          return _context0.f(14);
        case 15:
          return _context0.a(2);
      }
    }, _callee0, null, [[8, 13, 14, 15]]);
  }));
  return _generateTracker.apply(this, arguments);
}
function main() {
...
settingsManager.initializeSettings().then(function (_result) {
  main();
})["catch"](function (error) {
  (0, config_1.st_echo)('error', error);
  globalContext.Popup.show.confirm('Data migration failed. Do you want to reset the WTracker data?', 'Reset WTracker Data').then(function (result) {
    if (result) {
      settingsManager.resetSettings();
      main();
    }
